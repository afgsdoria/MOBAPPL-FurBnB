...
public class Booking_DayBoarding_Summary extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.booking_day_boarding_summary);

        ImageView returnButton = findViewById(R.id.return_bttn);
        returnButton.setOnClickListener(v -> {
            Intent intent = new Intent(Booking_DayBoarding_Summary.this, Booking_DayBoarding.class);
        ...
        String checkInTime = getIntent().getStringExtra("checkInTime"); // Corrected to checkInTime
        String checkOutTime = getIntent().getStringExtra("checkOutTime"); // Corrected to checkOutTime
    ...
    private void showConfirmationDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("OK", (dialog, which) -> {
                    ...
                    Intent intent = new Intent(Booking_DayBoarding_Summary.this, HomePage.class);
                    startActivity(intent);
                    finish();
                })
                .setCancelable(false)
