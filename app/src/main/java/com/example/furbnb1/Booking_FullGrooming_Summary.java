...
public class Booking_FullGrooming_Summary extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.booking_full_grooming_summary);

        ImageView returnButton = findViewById(R.id.return_bttn);
        returnButton.setOnClickListener(v -> {
            Intent intent = new Intent(Booking_FullGrooming_Summary.this, Booking_FullGrooming.class);
    ...
    private void showConfirmationDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("OK", (dialog, which) -> {
                    ...
                    Intent intent = new Intent(Booking_FullGrooming_Summary.this, HomePage.class);
                    startActivity(intent);
                    finish();
                })
                .setCancelable(false)
