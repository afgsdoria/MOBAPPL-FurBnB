...
public class Booking_BathAndBlow extends ComponentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.booking_bath_blow);

        ImageView returnButton = findViewById(R.id.return_bttn);
        returnButton.setOnClickListener(v -> {
            Intent intent = new Intent(Booking_BathAndBlow.this, Booking.class);
    ...
    private int calculatePrice() {
        ...
        Log.d("BathAndBlow", "Selected Size 1: " + size1);
        Log.d("BathAndBlow", "Selected Size 2: " + size2);
        ...
        Log.d("BathAndBlow", "Calculated Total Price: " + totalPrice);
        return totalPrice;
    }
    ...
    private void openConfirmAppointmentActivity() {
        ...
        //for the price
        Log.d("BathAndBlow", "Sending Total Price: " + totalPrice);

        Intent intent = new Intent(Booking_BathAndBlow.this, Booking_BathAndBlow_Summary.class);
